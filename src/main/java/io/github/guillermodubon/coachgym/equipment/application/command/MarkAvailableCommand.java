...
/**
 * Explicit command to transition equipment from {@code OUT_OF_SERVICE} to
 * {@code AVAILABLE}.
 *
 ...
 */
public record MarkAvailableCommand(UUID equipmentId, String reason, long version) {

    public MarkAvailableCommand {
        if (equipmentId == null) {
