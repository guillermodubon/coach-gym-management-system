...
/**
 * Published after an equipment category has been activated successfully.
 */
public record EquipmentCategoryActivatedEvent(
        UUID categoryId,
        String categoryName,
        UUID actorUserId,
    ...
    public EquipmentCategoryActivatedEvent {
        categoryId =
                requireValue(
                        categoryId,
